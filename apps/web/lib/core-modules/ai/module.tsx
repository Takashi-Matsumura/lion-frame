...
export const aiModule: AppModule = {
  ...
  menus: [
    ...
    },
    {
      ...
      icon: (
        <svg
          key="ai-playground-settings-icon"
          className="w-5 h-5 flex-shrink-0"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
  ...
  services: [
    ...
    },
    {
      ...
      nameJa: "AI体験 API",
      description: "AI Playground chat, search, and RAG endpoints",
      descriptionJa: "AI体験のチャット・検索・RAGエンドポイント",
      apiEndpoints: [
        "/api/ai-playground/chat",
        "/api/ai-playground/search",
        "/api/ai-playground/rag",
        "/api/ai-playground/settings",
      ],
      enabled: true,
    },
    {
